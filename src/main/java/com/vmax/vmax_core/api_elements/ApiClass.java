...
public abstract class ApiClass extends ApiType {
     ...
     * This list is passed to the constructor from externally. 
     * If the class has no superclasses, an empty list has to be passed, passing <code>null</code> is not allowed.
    */
