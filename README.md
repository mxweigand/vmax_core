...
This also means, that while the approach describes a general interface for APIs of object oriented software, this repository only provides a Java based implementation. 
